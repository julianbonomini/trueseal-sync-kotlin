...
internal interface UniffiCallbackInterfaceNoiseTransportMethod0 : com.sun.jna.Callback {
    fun callback(`uniffiHandle`: Long,`count`: Long,`uniffiOutReturn`: RustBuffer,uniffiCallStatus: UniffiRustCallStatus,)
}
internal interface UniffiCallbackInterfaceNoiseTransportMethod1 : com.sun.jna.Callback {
    fun callback(`uniffiHandle`: Long,`data`: RustBuffer.ByValue,`uniffiOutReturn`: Pointer,uniffiCallStatus: UniffiRustCallStatus,)
}
@Structure.FieldOrder("read", "write", "uniffiFree")
internal open class UniffiVTableCallbackInterfaceNoiseTransport(
    @JvmField internal var `read`: UniffiCallbackInterfaceNoiseTransportMethod0? = null,
    @JvmField internal var `write`: UniffiCallbackInterfaceNoiseTransportMethod1? = null,
    @JvmField internal var `uniffiFree`: UniffiCallbackInterfaceFree? = null,
) : Structure() {
    class UniffiByValue(
        `read`: UniffiCallbackInterfaceNoiseTransportMethod0? = null,
        `write`: UniffiCallbackInterfaceNoiseTransportMethod1? = null,
        `uniffiFree`: UniffiCallbackInterfaceFree? = null,
    ): UniffiVTableCallbackInterfaceNoiseTransport(`read`,`write`,`uniffiFree`,), Structure.ByValue

   internal fun uniffiSetValue(other: UniffiVTableCallbackInterfaceNoiseTransport) {
        `read` = other.`read`
        `write` = other.`write`
    ...
    companion object {
        internal val INSTANCE: UniffiLib by lazy {
            ...
            .also { lib: UniffiLib ->
                ...
                uniffiCallbackInterfaceNoiseTransport.register(lib)
                }
        }
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    if (lib.uniffi_trueseal_noise_checksum_func_accept_nk() != 61.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_noise_checksum_func_accept_xx() != 9498.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_noise_checksum_func_dial_nk() != 64332.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_noise_checksum_func_dial_xx() != 25620.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_noise_checksum_func_generate_keypair() != 57326.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_noise_checksum_func_new_keypair() != 30892.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_noise_checksum_method_noisetransport_read() != 385.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_noise_checksum_method_noisetransport_write() != 33840.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_noise_checksum_method_sessionnk_close() != 14013.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_noise_checksum_method_sessionnk_receive() != 26102.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_noise_checksum_method_sessionnk_send() != 27934.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_noise_checksum_method_sessionxx_close() != 16005.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_noise_checksum_method_sessionxx_receive() != 33526.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_noise_checksum_method_sessionxx_remote_public_key() != 41058.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_noise_checksum_method_sessionxx_send() != 12500.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
}
 ...
 */
public interface NoiseTransport {
    
    fun `read`(`count`: kotlin.ULong): List<kotlin.UByte>
    
    fun `write`(`data`: List<kotlin.UByte>)
 ...
 * Both methods may throw NoiseError on I/O failure.
 */
open class NoiseTransportImpl: Disposable, AutoCloseable, NoiseTransport {
    ...
    @Throws(NoiseException::class)override fun `read`(`count`: kotlin.ULong): List<kotlin.UByte> {
    ...
    @Throws(NoiseException::class)override fun `write`(`data`: List<kotlin.UByte>)
        = 
    callWithPointer {
    uniffiRustCallWithError(NoiseException) { _status ->
...
internal object uniffiCallbackInterfaceNoiseTransport {
    internal object `read`: UniffiCallbackInterfaceNoiseTransportMethod0 {
        override fun callback(`uniffiHandle`: Long,`count`: Long,`uniffiOutReturn`: RustBuffer,uniffiCallStatus: UniffiRustCallStatus,) {
            val uniffiObj = FfiConverterTypeNoiseTransport.handleMap.get(uniffiHandle)
            val makeCall = { ->
                uniffiObj.`read`(
                    FfiConverterULong.lift(`count`),
                )
            }
            ...
            uniffiTraitInterfaceCallWithError(
                ...
                makeCall,
                writeReturn,
                { e: NoiseException -> FfiConverterTypeNoiseError.lower(e) }
            )
        }
    }
    internal object `write`: UniffiCallbackInterfaceNoiseTransportMethod1 {
    ...
    internal object uniffiFree: UniffiCallbackInterfaceFree {
        override fun callback(handle: Long) {
            FfiConverterTypeNoiseTransport.handleMap.remove(handle)
        }
    }

    internal var vtable = UniffiVTableCallbackInterfaceNoiseTransport.UniffiByValue(
        `read`,
        `write`,
        uniffiFree,
    )
 ...
 * @suppress
 */
public object FfiConverterTypeNoiseTransport: FfiConverter<NoiseTransport, Pointer> {
    internal val handleMap = UniffiHandleMap<NoiseTransport>()

    override fun lower(value: NoiseTransport): Pointer {
        return Pointer(handleMap.insert(value))
    }

    override fun lift(value: Pointer): NoiseTransport {
        return NoiseTransportImpl(value)
    }

    override fun read(buf: ByteBuffer): NoiseTransport {
        // The Rust code always writes pointers as 8 bytes, and will
        // fail to compile if they don't fit.
        return lift(Pointer(buf.getLong()))
    }

    override fun allocationSize(value: NoiseTransport) = 8UL

    override fun write(value: NoiseTransport, buf: ByteBuffer) {
 ...
 */
public interface SessionNkInterface {
    
    fun `close`()
    
    fun `receive`(): List<kotlin.UByte>
    
    fun `send`(`payload`: List<kotlin.UByte>)
 ...
 * the Initiator already knew the Responder's key before the handshake.
 */
open class SessionNk: Disposable, AutoCloseable, SessionNkInterface {
    ...
    @Throws(NoiseException::class)override fun `close`()
        = 
    callWithPointer {
    uniffiRustCallWithError(NoiseException) { _status ->
    ...
    @Throws(NoiseException::class)override fun `receive`(): List<kotlin.UByte> {
            return FfiConverterSequenceUByte.lift(
    callWithPointer {
    uniffiRustCallWithError(NoiseException) { _status ->
    ...
    @Throws(NoiseException::class)override fun `send`(`payload`: List<kotlin.UByte>)
        = 
    callWithPointer {
    uniffiRustCallWithError(NoiseException) { _status ->
 ...
 * @suppress
 */
public object FfiConverterTypeSessionNk: FfiConverter<SessionNk, Pointer> {

    override fun lower(value: SessionNk): Pointer {
        return value.uniffiClonePointer()
    }

    override fun lift(value: Pointer): SessionNk {
        return SessionNk(value)
    }

    override fun read(buf: ByteBuffer): SessionNk {
        // The Rust code always writes pointers as 8 bytes, and will
        // fail to compile if they don't fit.
        return lift(Pointer(buf.getLong()))
    }

    override fun allocationSize(value: SessionNk) = 8UL

    override fun write(value: SessionNk, buf: ByteBuffer) {
        // The Rust code always expects pointers written as 8 bytes,
        // and will fail to compile if they don't fit.
        buf.putLong(Pointer.nativeValue(lower(value)))
    }
 ...
 */
public interface SessionXxInterface {
     ...
     */
    fun `remotePublicKey`(): List<kotlin.UByte>
 ...
 * remote peer unconditionally — mutual authentication is guaranteed by XX.
 */
open class SessionXx: Disposable, AutoCloseable, SessionXxInterface {
     ...
     * Returns the authenticated static public key of the remote peer.
     * Always present — XX guarantees mutual authentication.
     */override fun `remotePublicKey`(): List<kotlin.UByte> {
            return FfiConverterSequenceUByte.lift(
    callWithPointer {
 ...
 * @suppress
 */
public object FfiConverterTypeSessionXx: FfiConverter<SessionXx, Pointer> {

    override fun lower(value: SessionXx): Pointer {
        return value.uniffiClonePointer()
    }

    override fun lift(value: Pointer): SessionXx {
        return SessionXx(value)
    }

    override fun read(buf: ByteBuffer): SessionXx {
        // The Rust code always writes pointers as 8 bytes, and will
        // fail to compile if they don't fit.
        return lift(Pointer(buf.getLong()))
    }

    override fun allocationSize(value: SessionXx) = 8UL

    override fun write(value: SessionXx, buf: ByteBuffer) {
        // The Rust code always expects pointers written as 8 bytes,
        // and will fail to compile if they don't fit.
        buf.putLong(Pointer.nativeValue(lower(value)))
    }
 ...
 * @suppress
 */
public object FfiConverterTypeKeypairRecord: FfiConverterRustBuffer<KeypairRecord> {
    override fun read(buf: ByteBuffer): KeypairRecord {
...
sealed class NoiseException: kotlin.Exception() {
    ...
    companion object ErrorHandler : UniffiRustCallStatusErrorHandler<NoiseException> {
        override fun lift(error_buf: RustBuffer.ByValue): NoiseException = FfiConverterTypeNoiseError.lift(error_buf)
    }
 ...
 * @suppress
 */
public object FfiConverterTypeNoiseError : FfiConverterRustBuffer<NoiseException> {
    override fun read(buf: ByteBuffer): NoiseException {
        

        return when(buf.getInt()) {
            1 -> NoiseException.Transport(
                FfiConverterString.read(buf),
                )
            2 -> NoiseException.Handshake(
                FfiConverterString.read(buf),
                )
            3 -> NoiseException.Closed()
            4 -> NoiseException.PayloadTooLarge()
            else -> throw RuntimeException("invalid error enum value, something is very wrong!!")
        }
    }

    override fun allocationSize(value: NoiseException): ULong {
        return when(value) {
            is NoiseException.Transport -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.`message`)
            )
            is NoiseException.Handshake -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
                + FfiConverterString.allocationSize(value.`message`)
            )
            is NoiseException.Closed -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
            is NoiseException.PayloadTooLarge -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
        }
    ...
    override fun write(value: NoiseException, buf: ByteBuffer) {
        when(value) {
            is NoiseException.Transport -> {
                buf.putInt(1)
