...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    if (lib.uniffi_trueseal_sync_checksum_method_truesealffisession_accept_member() != 18095.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_sync_checksum_method_truesealffisession_cancel_pairing() != 42407.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_sync_checksum_method_truesealffisession_destroy_group() != 41796.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_sync_checksum_method_truesealffisession_join_group() != 4878.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_sync_checksum_method_truesealffisession_local_device_name() != 4828.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_sync_checksum_method_truesealffisession_local_node_id() != 22773.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_sync_checksum_method_truesealffisession_members() != 52165.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_sync_checksum_method_truesealffisession_pairing_token() != 64105.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_sync_checksum_method_truesealffisession_remove_member() != 31245.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_sync_checksum_method_truesealffisession_send() != 13906.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_sync_checksum_method_truesealffisession_set_on_member_joined() != 26978.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_sync_checksum_method_truesealffisession_set_on_member_left() != 30567.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_sync_checksum_method_truesealffisession_set_on_member_request() != 28338.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_sync_checksum_constructor_truesealffisession_create() != 8976.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_sync_checksum_method_connectionchangedcallback_on_connection_changed() != 21548.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_sync_checksum_method_groupdestroyedcallback_on_group_destroyed() != 23245.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_sync_checksum_method_memberjoinedcallback_on_member_joined() != 49246.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_trueseal_sync_checksum_method_memberleftcallback_on_member_left() != 41313.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
